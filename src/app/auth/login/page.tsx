      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div
            ...
            style={{ background: "linear-gradient(135deg, #111111 0%, #374151 100%)", boxShadow: "0 8px 24px rgba(0,0,0,0.18)" }}
          >
        ...
        >
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-2xl font-semibold text-sm transition-all hover:opacity-90 active:scale-95"
            style={{
